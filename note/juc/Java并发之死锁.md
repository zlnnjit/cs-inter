在上一篇文章中，我们用 Account.class 作为互斥锁，来解决银行业务里面的转账问题，虽然这个方案不存在并发问题，但是所有账户的转账操作都是串行的，例如账户 A 转账户 B、账户 C 转账户 D 这两个转账操作现实世界里是可以并行的，但是在这个方案里却被**串行化**了，这样的话，性能太差。
...
![](http://img.bcoder.top/2020.01.07.1/1.png)
...
![](http://img.bcoder.top/2020.01.07.1/2.png)
...
![](http://img.bcoder.top/2020.01.07.1/3.png)
...
![](http://img.bcoder.top/2020.01.07.1/4.png)
