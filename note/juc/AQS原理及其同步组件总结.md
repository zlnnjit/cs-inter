...
![](http://img.bcoder.top/2019.12.29.2/1.png)
...
![](http://img.bcoder.top/2019.12.29.2/2.png)
...
上面的代码中，我们定义了请求的数量为 550，当这 550 个请求被处理完成之后，才会执行`System.out.println("main finish");`。
