...
![](http://img.bcoder.top/2019.12.17.1/1.png)
...
![](http://img.bcoder.top/2019.12.17.1/2.png)
...
![](http://img.bcoder.top/2019.12.17.1/3.png)

要解决这个问题，就需要把变量声明为**volatile**，这就指示 JVM，这个变量是不稳定的，每次使用它都到主存中进行读取。

说白了， **volatile** 关键字的主要作用就是保证变量的可见性然后还有一个作用是防止指令重排序。

![](http://img.bcoder.top/2019.12.17.1/4.png)
...
![](http://img.bcoder.top/2019.12.17.1/5.png)
...
![](http://img.bcoder.top/2019.12.17.1/6.png)
...
- 四种方式的详情请参考：
  ...
  - https://www.jianshu.com/p/436b97989fe4

**方式一：通过构造方法实现**

![](http://img.bcoder.top/2019.12.17.1/7.png)
...
- **nScheduledThreadPool**：创建一个定长线程池，支持定时及周期性任务执行

对应Executors工具类中的方法如图所示：

![](http://img.bcoder.top/2019.12.17.1/8.png)
...
我们这里以阿里巴巴推荐的使用 `ThreadPoolExecutor` 构造函数自定义参数的方式来创建线程池。
...
![](http://img.bcoder.top/2019.12.17.1/9.png)
...
**为了搞懂线程池的原理，我们需要首先分析一下 `execute`方法。** Demo 中我们使用 `executor.execute(worker)`来提交一个任务到线程池中去，这个方法非常重要，下面我们来看看它的源码：
...
![](http://img.bcoder.top/2019.12.17.1/10.png)
...
![](http://img.bcoder.top/2019.12.17.1/11.png)
...
原子类存在ABA问题：https://www.jianshu.com/p/ffd59fbdb4fa
...
![](http://img.bcoder.top/2019.12.17.1/12.png)
...
![](http://img.bcoder.top/2019.12.17.1/13.png)
