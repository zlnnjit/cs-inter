...
![](http://img.bcoder.top/2019.12.25.1/1.png)



**JDK1.7的ConcurrentHashMap：**

![](http://img.bcoder.top/2019.12.25.1/2.png)



**JDK1.8的ConcurrentHashMap（TreeBin: 红黑二叉树节点 Node: 链表节点）：**

![](http://img.bcoder.top/2019.12.25.1/3.png)
...
详细实现原理：https://www.cnblogs.com/chengxiao/p/6842045.html
...
![](http://img.bcoder.top/2019.12.25.1/4.png)
...
详细请了解：[解读 java 并发队列 BlockingQueue](https://javadoop.com/post/java-concurrent-queue)
...
![](http://img.bcoder.top/2019.12.25.1/5.png)

最低层的链表维护了跳表内所有的元素，每上面一层链表都是下面一层的子集。

跳表内的所有链表的元素都是排序的。查找时，可以从顶级链表开始找。一旦发现被查找的元素大于当前链表中的取值，就会转入下一层链表继续找。这也就是说在查找过程中，搜索是跳跃式的。如上图所示，在跳表中查找元素 18。

![](http://img.bcoder.top/2019.12.25.1/6.png)
