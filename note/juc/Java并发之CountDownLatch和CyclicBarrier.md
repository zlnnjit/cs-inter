...
![](http://img.bcoder.top/2020.01.27.5/1.png)
...
![](http://img.bcoder.top/2020.01.27.5/2.png)
...
![](http://img.bcoder.top/2020.01.27.5/3.png)
...
经过上面的优化之后，基本上可以收工了，但还是有点美中不足，相信你也发现了，while 循环里面每次都会创建新的线程，而创建线程可是个耗时的操作。所以最好是创建出来的线程能够循环利用，估计这时你已经想到线程池了，是的，线程池就能解决这个问题。
...
![](http://img.bcoder.top/2020.01.27.5/4.png)
...
![](http://img.bcoder.top/2020.01.27.5/5.png)
...
![](http://img.bcoder.top/2020.01.27.5/6.png)
