之前的文章中，我和你介绍了InnoDB的间隙锁、next-key lock，以及加锁规则。针对几个主要问题进行复习。
...
![](http://img.bcoder.top/2020.02.03.3/1.png)
...
与上面这个例子对应的，是同学提出的问题：下面这个语句的加锁范围是什么？
...
![](http://img.bcoder.top/2020.02.03.3/2.png)
...
![](http://img.bcoder.top/2020.02.03.3/3.png)
...
有同学做了一个有趣验证，我把复现步骤列出来：

![](http://img.bcoder.top/2020.02.03.3/4.png)
...
![](http://img.bcoder.top/2020.02.03.3/5.png)
...
看过了insert和delete的加锁例子，我们再来看一个update语句的案例。在同学做了这个试验：

![](http://img.bcoder.top/2020.02.03.3/6.png)
...
![](http://img.bcoder.top/2020.02.03.3/7.png)
...
再次跟你复习了加锁规则。并且，我和你重点说明了，分析加锁范围时，一定要配合语句执行逻辑来进行。
...
**1.所谓“间隙”，其实根本就是由“这个间隙右边的那个记录”定义的。**
...
![](http://img.bcoder.top/2020.02.03.3/8.png)



![](http://img.bcoder.top/2020.02.03.3/9.png)
