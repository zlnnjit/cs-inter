...
![](http://img.bcoder.top/2020.02.03.6/1.png)
...
![](http://img.bcoder.top/2020.02.03.6/2.png)
...
当然前提是查询返回结果不多。同学说到自己因为执行了一个大查询导致客户端占用内存近20G，这种情况下就需要改用mysql_use_result接口了。
...
![](http://img.bcoder.top/2020.02.03.6/3.png)



![](http://img.bcoder.top/2020.02.03.6/4.png)
...
之前介绍WAL机制的时候，和你分析了InnoDB内存的一个作用，是保存更新的结果，再配合redo log，就避免了随机写盘。
...
![](http://img.bcoder.top/2020.02.03.6/5.png)
...
![](http://img.bcoder.top/2020.02.03.6/6.png)
...
![](http://img.bcoder.top/2020.02.03.6/7.png)
...
**1.在文章中说到，如果由于客户端压力太大，迟迟不能接收结果，会导致MySQL无法发送结果而影响语句执行。但，这还不是最糟糕的情况。**
