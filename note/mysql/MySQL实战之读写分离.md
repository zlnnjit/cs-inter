...
![](http://img.bcoder.top/2020.02.03.1/1.png)
...
![](http://img.bcoder.top/2020.02.03.1/2.png)
...
![](http://img.bcoder.top/2020.02.03.1/3.png)
...
![](http://img.bcoder.top/2020.02.03.1/4.png)
...
![](http://img.bcoder.top/2020.02.03.1/5.png)
...
![](http://img.bcoder.top/2020.02.03.1/6.png)
...
![](http://img.bcoder.top/2020.02.03.1/7.png)
...
之前介绍mysql_reset_connection的时候，有同学留言问这类接口应该怎么使用。
...
![](http://img.bcoder.top/2020.02.03.1/8.png)

这样，就可以看到语句执行完成，显示出GITD的值。

![](http://img.bcoder.top/2020.02.03.1/9.png)
...
**1.假设你的系统采用了我们文中介绍的最后一个方案，也就是等GTID的方案，现在你要对主库的一张大表做DDL，可能会出现什么情况呢？为了避免这种情况，你会怎么做呢？**
