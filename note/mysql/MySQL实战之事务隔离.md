...
![](http://img.bcoder.top/2020.01.29.8/1.png)
...
配置的方式是，将启动参数transaction-isolation的值设置成READ-COMMITTED。你可以用`select @@global.tx_isolation;`来查看当前的值。

![](http://img.bcoder.top/2020.01.29.8/2.png)
...
![](http://img.bcoder.top/2020.01.29.8/3.png)
